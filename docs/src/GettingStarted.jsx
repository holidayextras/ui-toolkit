  ...
  render: function () {
    return (
      <section>
        ...
        <p>You can install UI Toolkit using <a href="https://www.npmjs.com/" alt="npm">npm</a> or alternativel download or contribute to the project on <a href="https://github.com/holidayextras/ui-toolkit" title="UI Toolkit on GitHub">GitHub</a></p>
